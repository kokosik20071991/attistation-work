...
2. Переименовать файл, дав ему новое имя (Друзья человека).  Создать директорию, переместить файл туда.
![Alt text](image.png)
...
5. Выложить историю команд в терминале ubuntu(история команд отображена на скринах ранее)
